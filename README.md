...
鉴于同步带计算传动比简单很多，因此着重设计了B-roll的结构，使用了多级皮带轮，需要实际做一下，测试精度和稳定性，曾想过把预览轴用屏幕取代，但是感觉会使原机械风味丧失大半，所以还是保留。

【A-roll：最大的转盘，B-roll：二级转盘，C-roll：八面轴，view-roll：预览轴】

<img title="" src="imgs/v031_head.jpg" alt="v031 preview">
